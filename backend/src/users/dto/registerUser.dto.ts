import {
  ...
  export class RegisterUserDto {
    ...
    @ApiProperty({
      description:
        'The field name must be a string of text',
      example: 'Jhon Wayne',
      required: true,
    })
    name: string;
    ...
    @ApiProperty({
      description:
        'The field given_name must be a string of text',
      example: 'Jhon',
      required: true,
    })
    given_name: string;
    ...
    @ApiProperty({
      description:
        'The field family_name must be a string of text',
      example: 'Wayne',
      required: true,
    })
    family_name: string;
    ...
    @ApiProperty({
      description:
        'The field preferred_name must be a string of text',
      example: 'Jhon',
      required: false,
    })
    ...
    @ApiProperty({
      description:
        'The birth_date field must be a string',
      example: '1/1/1980',
      required: false,
    })
    birth_date?: string;
    ...
    @ApiProperty({
      description:
        'The notes field must be a string of text',
    ...
    @ApiProperty({
      description:
        'The primary_phone_number field must be a string',
      example: '123456789',
      required: false,
    })
    ...
    @IsString({ message: 'The primary_email_address field must be a string of text' })
    @ApiProperty({
      description:
        'The primary_email_address field must be a string of text',
