...
const AppointmentsDateTime = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-100 p-6'>
        ...
        <div className='mt-4 flex justify-center gap-4'>
          {['This Week', 'This Month', 'Next Month'].map((filter) => (
            <button
              ...
              onClick={() =>
                setSelectedFilter(
                  filter as 'This Week' | 'This Month' | 'Next Month',
                )
              }
      ...
      <main className='mx-auto max-w-4xl rounded-lg bg-white p-6 shadow-lg'>
        <div className='grid grid-cols-3 gap-4'>
          {filteredSlots.map((slot) => (
            <div key={slot.date} className='rounded-lg border p-4'>
