  ...
  return (
    <header className='mb-4 flex flex-col gap-4 sm:mb-6 sm:flex-row sm:items-center sm:justify-between'>
      ...
      <button
        ...
        className='flex w-full items-center justify-center gap-2 rounded-lg bg-purple-500 px-3 py-2 text-sm text-white transition-colors hover:bg-purple-600 sm:w-auto sm:px-4 sm:text-base'
      >
